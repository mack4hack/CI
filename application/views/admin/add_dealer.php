						...
						<div class="portlet light bordered">
									<div class="portlet-title">
										<div class="caption">
											...
											<span class="caption-subject font-red-sunglo bold uppercase">Select Dealer City</span>
										</div>
										<div class="tools">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="password" onkeyup="return myFunction()" name="password" id="pass1" name="password" class="form-control required" placeholder="Enter Password">
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-body">
							...
							<tbody>
							<?php foreach($this->Admin_model->get_dealers() as $dealer )
							{
								?>
							<tr class="odd gradeX">
...
function loadData(loadType,loadId){
  ...
  $("#"+loadType+"_loader").fadeIn(400).html('<img src="<?php echo base_url()?>assets/loading.gif" />');
  $.ajax({
    type: "POST",
